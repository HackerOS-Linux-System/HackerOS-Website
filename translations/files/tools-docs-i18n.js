(function () {
    const NAV = {
        de: { 'hackeros-store': 'HackerOS Store', 'blue-environment': 'Blue Environment', 'hacker-launcher': 'Hacker Launcher' },
        fr: { 'hackeros-store': 'HackerOS Store', 'blue-environment': 'Blue Environment', 'hacker-launcher': 'Hacker Launcher' },
        es: { 'hackeros-store': 'HackerOS Store', 'blue-environment': 'Blue Environment', 'hacker-launcher': 'Hacker Launcher' },
        it: { 'hackeros-store': 'HackerOS Store', 'blue-environment': 'Blue Environment', 'hacker-launcher': 'Hacker Launcher' },
        ru: { 'hackeros-store': 'HackerOS Store', 'blue-environment': 'Blue Environment', 'hacker-launcher': 'Hacker Launcher' },
        uk: { 'hackeros-store': 'HackerOS Store', 'blue-environment': 'Blue Environment', 'hacker-launcher': 'Hacker Launcher' },
        zh: { 'hackeros-store': 'HackerOS Store', 'blue-environment': 'Blue Environment', 'hacker-launcher': 'Hacker Launcher' },
        ja: { 'hackeros-store': 'HackerOS Store', 'blue-environment': 'Blue Environment', 'hacker-launcher': 'Hacker Launcher' },
    };
