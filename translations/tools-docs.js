window.HACKEROS_TRANS_TOOLS = {
    ...
    en: {
        ...
        slides: [
            ...
            { title: "ULB", desc: "Universal Live Builder – elite tool for building HackerOS ISO images. Enables creation of fully configurable, portable live environments and images for mass deployments." },
...
// Extra language stubs for tools-docs (slides + navItems inherited from EN)

window.HACKEROS_TRANS_TOOLS['de'] = Object.assign({},
    window.HACKEROS_TRANS_TOOLS.en,
    {"pageTitle": "HackerOS · Ökosystem & Tools", "sectionH2": "Das HackerOS-Ökosystem entdecken.", "footerCopy": "HackerOS · © 2026 HackerOS. Alle Rechte vorbehalten. | HackerOS Ecosystem-Dokumentation", "langDropBtn": "Programmiersprachen", "langDropLinks": {"hsharp": "H# – Dokumentation", "hackerLang": "Hacker Lang – Dokumentation"}}
);

window.HACKEROS_TRANS_TOOLS['fr'] = Object.assign({},
    window.HACKEROS_TRANS_TOOLS.en,
    {"pageTitle": "HackerOS · Écosystème & outils", "sectionH2": "Découvrez l'écosystème HackerOS.", "footerCopy": "HackerOS · © 2026 HackerOS. Tous droits réservés. | Documentation écosystème HackerOS", "langDropBtn": "Langages de programmation", "langDropLinks": {"hsharp": "H# – documentation", "hackerLang": "Hacker Lang – documentation"}}
);

window.HACKEROS_TRANS_TOOLS['es'] = Object.assign({},
    window.HACKEROS_TRANS_TOOLS.en,
    {"pageTitle": "HackerOS · Ecosistema & herramientas", "sectionH2": "Explora el ecosistema de HackerOS.", "footerCopy": "HackerOS · © 2026 HackerOS. Todos los derechos reservados. | Documentación del ecosistema HackerOS", "langDropBtn": "Lenguajes de programación", "langDropLinks": {"hsharp": "H# – documentación", "hackerLang": "Hacker Lang – documentación"}}
);

window.HACKEROS_TRANS_TOOLS['it'] = Object.assign({},
    window.HACKEROS_TRANS_TOOLS.en,
    {"pageTitle": "HackerOS · Ecosistema & strumenti", "sectionH2": "Scopri l'ecosistema di HackerOS.", "footerCopy": "HackerOS · © 2026 HackerOS. Tutti i diritti riservati. | Documentazione ecosistema HackerOS", "langDropBtn": "Linguaggi di programmazione", "langDropLinks": {"hsharp": "H# – documentazione", "hackerLang": "Hacker Lang – documentazione"}}
);

window.HACKEROS_TRANS_TOOLS['ru'] = Object.assign({},
    window.HACKEROS_TRANS_TOOLS.en,
    {"pageTitle": "HackerOS · Экосистема и инструменты", "sectionH2": "Познакомьтесь с экосистемой HackerOS.", "footerCopy": "HackerOS · © 2026 HackerOS. Все права защищены. | Документация экосистемы HackerOS", "langDropBtn": "Языки программирования", "langDropLinks": {"hsharp": "H# – документация", "hackerLang": "Hacker Lang – документация"}}
);

window.HACKEROS_TRANS_TOOLS['uk'] = Object.assign({},
    window.HACKEROS_TRANS_TOOLS.en,
    {"pageTitle": "HackerOS · Екосистема та інструменти", "sectionH2": "Ознайомтеся з екосистемою HackerOS.", "footerCopy": "HackerOS · © 2026 HackerOS. Усі права захищені. | Документація екосистеми HackerOS", "langDropBtn": "Мови програмування", "langDropLinks": {"hsharp": "H# – документація", "hackerLang": "Hacker Lang – документація"}}
);

window.HACKEROS_TRANS_TOOLS['zh'] = Object.assign({},
    window.HACKEROS_TRANS_TOOLS.en,
    {"pageTitle": "HackerOS · 生态系统与工具", "sectionH2": "探索 HackerOS 生态系统。", "footerCopy": "HackerOS · © 2026 HackerOS. 保留所有权利。| HackerOS 生态系统文档", "langDropBtn": "编程语言", "langDropLinks": {"hsharp": "H# – 文档", "hackerLang": "Hacker Lang – 文档"}}
);

window.HACKEROS_TRANS_TOOLS['ja'] = Object.assign({},
    window.HACKEROS_TRANS_TOOLS.en,
    {"pageTitle": "HackerOS · エコシステム & ツール", "sectionH2": "HackerOS エコシステムを探索する。", "footerCopy": "HackerOS · © 2026 HackerOS. 全著作権所有。| HackerOS エコシステムドキュメント", "langDropBtn": "プログラミング言語", "langDropLinks": {"hsharp": "H# – ドキュメント", "hackerLang": "Hacker Lang – ドキュメント"}}
);
